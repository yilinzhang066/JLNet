#' @title new_gmm
#'
#' @description  This function is designed to estimate the facility level effects.
#'
...
#'
#' @return   A list of two items: 1. a vector indicating the cluster allocated to and 2. a vector of fitted facility-level effect.

#' @export

new_gmm<-function(k, thetahat, sigma_all, nstart = 25)
{
  ...
  return(list(label_gmm=label_gmm,fitted_gmm=fitted_gmm))
}
